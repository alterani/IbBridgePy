...
# Otherwise, IBridgePy will stop when a security is not in security_info.csv
...
def handle_data(context, data):
    ...
    # The response have two fields: reqId and result, a pandas dataframe
    # reqId is used to cancel the stock scanner later, otherwise the scanner will keep going.
    # result is the real returned results in a pandas dataframe
    reqId = response.reqId
    result = response.result

    # reqId is used to cancel the stock scanner.
    cancel_scanner_request(reqId)
    print(result)
